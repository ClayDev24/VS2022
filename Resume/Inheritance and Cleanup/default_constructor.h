...
namespace resume {
	...
	public:
		...
		NoDefault(int _i) :i(_i) { std::cout << "NoDefault(" << _i << ")\n"; }
		~NoDefault() { std::cout << "~NoDefault()\n"; } // Automatic called when by the compile when obj goes outta scope.
		inline void print() { std::cout << "NoDefault.i: " << i << "\n"; }
	};
	...
	public:
		...
		Default() :i(0) {}
		Default(int _i) :i(_i) { std::cout << "Default(" << _i << ")\n"; }
		~Default() { std::cout << "~Default()\n"; } // Automatic called when by the compile when obj goes outta scope.
		inline void print() { std::cout << "Default.i: " << i << "\n"; }
	};
	...
	public:
		...
		~Auto() { std::cout << "~Auto()\n"; } // Automatic called when by the compile when obj goes outta scope.
		inline void print() { std::cout << "Auto.i: " << i << "\n"; }
	};
